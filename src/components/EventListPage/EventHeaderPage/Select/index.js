...
import { currentSelectCategoriesEventList, CURRENT_SELECT_CATEGORIES_EVENT_LIST, SET_SELECT_CATEGORIES_EVENT_LIST, SELECT_CATEGORIES_EVENT_LIST_IS_CLOSE, SELECT_CATEGORIES_EVENT_LIST_IS_OPEN } from '../../../../actions/events';

export default function SelectCategories() {
    const categoriesList = useSelector(state => state.events.selectCategoriesEventList)
    const dispatch = useDispatch()
    const {selectCategoriesEventListIsOpen, currentSelectCategoriesEventList} = useSelector(state => state.events);
