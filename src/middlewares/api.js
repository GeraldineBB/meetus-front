    ...
    case SET_NEW_EVENT: {
      ...
      // const {google: { value }} = store.getState();
        ...
        axios({
          ...
          data: {
            title : action.bodyFormData.title, 
            description: action.bodyFormData.description,
            date: action.bodyFormData.date,
            category: action.bodyFormData.category,
            maxMembers:action.bodyFormData.maxMembers,
            picture: action.bodyFormData.picture,
            address: action.bodyFormData.address,
            city: action.bodyFormData.city,
            country: action.bodyFormData.country,
            zipcode: action.bodyFormData.zipcode,
